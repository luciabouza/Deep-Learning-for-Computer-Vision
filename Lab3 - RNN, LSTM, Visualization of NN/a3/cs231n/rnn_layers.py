...
def rnn_backward(dh, cache):
    ...
    # para el últimpo instante de tiempo deberá ser cero ya que no trae info de ningún instante posterior    
    dprev_ht = np.zeros((N,H))

    for t in range(T-1,-1,-1):
        cachenext = cache[t]
        
        # considero los gradientes de L en el instante de tiempo t (input) y también el gradeinte de h del instante posterior
        ...
        # acutalizo el gradiente en función de la entrada para ese instante de tiempo
        dx[:,t,:] = dxt
        
    # el último gradiente de h del instante anterior, como itero con desde el ultimo instante, será el dh0   
    dh0 = dprev_ht
